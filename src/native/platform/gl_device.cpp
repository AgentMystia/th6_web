...
extern "C" HRESULT D3DXLoadSurfaceFromSurface(IDirect3DSurface8 *dst, const PALETTEENTRY *, const RECT *,
                                              IDirect3DSurface8 *srcS, const PALETTEENTRY *, const RECT *, DWORD,
                                              D3DCOLOR)
{
